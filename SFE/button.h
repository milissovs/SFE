...
#define DROP_WIDTH     10

class CButton
{
public:
	CButton();
	CButton(UINT nID, BOOL bHasChevron = FALSE);
	~CButton();
	...
	void SetChevron(BOOL bHasCevron);
	...
	void SetSeparator() { m_bSeparator = TRUE; m_fWidth = 5.0f; };
